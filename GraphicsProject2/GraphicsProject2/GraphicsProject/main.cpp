...
#pragma region GameTextures
    ...
    engine.meshManager->LoadTexture("NvF5e_height_map.bmp");
...
//
//    cMesh* groundPlane = engine.LoadMesh("Big_Flat_Mesh_256x256_00_132K_xyz_n_rgba_uv.ply", "groundPlane");
//    groundPlane->transperancy = 1.0f;
//    groundPlane->bDoNotLight = false;
////	groundPlane->color = glm::vec4(0.0f, 0.0f, 1.0f, 1.0f);
//  //  groundPlane->bUseDebugColours = true;
//    //groundPlane->wholeObjectDebugColourRGBA = glm::vec4(0.0f, 0.0f, 1.0f, 1.0f);
...
//    groundPlane->useHeightMap = true;
//    groundPlane->heightMap = "NvF5e_height_map.bmp";
//    groundPlane->heightMapScale = 10.0f;
//   // groundPlane->maskTexture = "EmptyMask.bmp";
...
#pragma endregion
    ...
    engine.LoadSave();
    cMesh* skyBoxMesh = engine.meshManager->FindMeshByFriendlyName("skybox");
    cMesh* billboard = engine.meshManager->FindMeshByFriendlyName("billboard");
