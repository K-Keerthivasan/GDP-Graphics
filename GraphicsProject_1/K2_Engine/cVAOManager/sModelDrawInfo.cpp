...
// Initialize the static member variable for unique IDs and set initial values.
unsigned int sModelDrawInfo::m_nextUniqueID = sModelDrawInfo::FIRST_UNIQUE_ID;

// Constructor for sModelDrawInfo
...
// Getter for the unique ID of the model draw info.
...
void sModelDrawInfo::calcExtents(void)
{
	...
	// Calculate the maximum extent among the three dimensions.
